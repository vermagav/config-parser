...
test:
	...
	g++ -Wall -Wno-unused-variable -std=c++11 config/item.cc config/item_test.cc -o bin/item_test
	./bin/item_test
	@echo "Done!"
	@echo "\n> 2 of 2: Running parser_test.cc..."
	g++ -Wall -Wno-unused-variable -std=c++11 config/parser.cc config/parser_test.cc config/item.cc -o bin/parser_test
	./bin/parser_test
	@echo "Done!"
